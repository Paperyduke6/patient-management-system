...
public class BillingServiceGrpcClient {
    ...
    private final BilliingServiceGrpc.BilliingServiceBlockingStub blockingStub;

    //    localhost:9001/BillingService/CreatePatientAccount
    //    aws:grpc:9001/BillingService/CreatePatientAccount
    ...
    public BillingServiceGrpcClient(
        ...
        blockingStub = BilliingServiceGrpc.newBlockingStub(channel);
    }
    ...
    public BillingResponse createBillingAccount(String patientId
        ...
        log.info("Recieved Repsonse from Billing service via GRPC: {}", response);
        return response;
    }
}
